...
test('should return "Weak" for long passwords with only one other property (e.g., one uppercase letter)', () => {
...
test('should return "Medium" for long passwords with two other properties (e.g., uppercase and number)', () => {
  expect(passwordValidator("Justupper1")).toBe("Medium");
});

// Cycle 4: Test for "Strong" strength
test('should return "Strong" for passwords that meet all criteria', () => {
  expect(passwordValidator("Justupper1!")).toBe("Strong");
});
